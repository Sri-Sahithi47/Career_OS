...
describe('AppliedJobs', () => {
  ...
  it('shows a count of applications in progress', () => {
    ...
    expect(screen.getByText(/of 4 entries/i)).toBeInTheDocument()
  })
  ...
  it('renders stage stat cards for each stage', () => {
    ...
    expect(screen.getAllByText('Offer')[0]).toBeInTheDocument()
  ...
  it('shows empty state when there are no applied jobs', () => {
    ...
    expect(screen.getByText('No applications to show.')).toBeInTheDocument()
  })
