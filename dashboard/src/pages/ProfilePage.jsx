...
function ProfilePage({ onboarding, onUpdated }) {
  ...
  const saveNotifications = () => {
    ...
    } catch { setMessage('Could not save notification preferences.') }
  }
        ...
        <section className="settings-card">
          <div className="settings-card-title">
            <div>
              ...
              <p>Used for account personalization and job matching.</p>
            </div>
          </div>
        ...
        <section className="settings-card">
          <div className="settings-card-title">
            <div>
              ...
              <p>Upload and manage your resume for job matching</p>
            </div>
          </div>
          <textarea
