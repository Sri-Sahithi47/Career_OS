...
(async () => {
  ...
  function scheduleTabCloseAfterSubmit() {
    chrome.runtime.sendMessage({
      type: "SCHEDULE_CLOSE_TAB",
      delayMs: CLOSE_AFTER_SUBMIT_DELAY_MS,
    }).catch(() => {});
  }
  ...
  function detectPageJob() {
    ...
    if (h.includes("kforce.com")) {
      ...
      description = linkedInDescription(detailsRoot) || linkedInDescription(document);
